...
public void Book_Img_Details_Check(String pic){
	BookDetails details = new BookDetails();
	details.setPicture(pic);
	Drawable drawable = new Drawable();
	Drawable drawable = getResources().getDrawable(getResources().getIdentifier(pic, "void", "R.drawable");
	assertEquals(details.getPicture(), drawable);
}